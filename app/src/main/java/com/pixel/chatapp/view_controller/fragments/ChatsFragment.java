...
import com.pixel.chatapp.view_controller.UsersContactActivity;
...
public class ChatsFragment extends Fragment {
    ...
    AppPermission appPermissionCheck = new AppPermission();
...
//        refChecks = FirebaseDatabase.getInstance().getReference("Checks");
        ...
        {
            if(appPermissionCheck.isContactOk(getContext()))
            {
                ...
                appPermissionCheck.requestContact(getActivity());
            }
