package com.pixel.chatapp.services.roomDatabase.database;
...
@Database(entities = {UserOnChatUI_Model.class, MessageModel.class}, version = 7, exportSchema = false)
...
//                    .fallbackToDestructiveMigration()
                    .addMigrations(MIGRATION_6_7) // Add your migration here
                    .build();
        }
    ...
    public static final Migration MIGRATION_6_7 = new Migration(6, 7) {
        ...
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            database.execSQL("ALTER TABLE chats RENAME COLUMN `from` TO senderName");
            database.execSQL("ALTER TABLE chats RENAME COLUMN isChatPin TO chatIsPin");
            database.execSQL("ALTER TABLE chats RENAME COLUMN isChatForward TO chatIsForward");
            database.execSQL("ALTER TABLE chats RENAME COLUMN id TO otherUid");
