...
public class ContactSearch {
    ...
    public ContactSearch(List<ContactModel> contacts) {
    ...
    public List<ContactModel> searchContacts() {
        ...
        Collections.sort(filteredContacts, (c1, c2) ->
        {
            ...
            if (distance1 < distance2) {
                return -1; // Negative value because distance1 is less than distance2
            } else if (distance1 > distance2) {
                return 1; // Positive value because distance1 is greater than distance2
            } else {
                return 0; // Zero because distance1 equals distance2
            }
        });
