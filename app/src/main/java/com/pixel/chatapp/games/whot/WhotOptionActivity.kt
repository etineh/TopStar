...
import com.pixel.chatapp.games.whot.WhotOptionActivity.TriggerInterface.triggerOnForward
...
import com.pixel.chatapp.utils.PhoneUtils.CheckInternet
import com.pixel.chatapp.utils.WalletUtils

class WhotOptionActivity : AppCompatActivity() {

    private var myNumber: Long = 55L
...
//                }, 1000)
    ...
    fun slideInFromLeft(view: ImageView?=null, duration: Int){
        println("what is: $duration $myNumber ")
    }
    ...
    private fun setChooseModeView(){
        if(chooseModeView == null){
            ...
            selectPlayerButton = chooseModeView?.findViewById<TextView>(R.id.selectPlayerbutton)
            selectPlayerButton?.text = getString(R.string.selectPlayer)
